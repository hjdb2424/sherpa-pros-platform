...
const REFERRAL_CODE = 'SHERPA-JD2024';
...
const RECENT_REFERRALS: Referral[] = [
  { id: '1', name: 'Emily Watson', date: 'Apr 12, 2026', status: 'first_job' },
  { id: '2', name: 'David Park', date: 'Apr 7, 2026', status: 'joined' },
  { id: '3', name: 'Samantha Moore', date: 'Mar 30, 2026', status: 'invited' },
];
      ...
      >
        ...
        <Card style={styles.rewardCard} variant="elevated">
          ...
          <Text style={styles.rewardText}>
            Earn $25 credit for each friend who posts their first job. Share your code, they sign up, and once their first job is posted -- you both win.
          </Text>
        </Card>
      </ScrollView>
    </View>
