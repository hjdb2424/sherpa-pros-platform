  ...
  return (
    <>
      ...
      <aside className="fixed top-0 left-0 z-40 hidden h-full w-64 flex-col border-r border-zinc-100 bg-white lg:flex dark:border-zinc-800 dark:bg-zinc-950">
        ...
        {/* Profile, Settings & User section */}
        <div className="border-t border-zinc-100 p-4 space-y-1 dark:border-zinc-800">
          <Link
            href="/pm/profile"
            className={`flex items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium transition-colors ${
              isActive('/pm/profile')
          ...
          <Link href="/pm/profile" className="mt-2 flex items-center gap-3 rounded-lg px-2 py-2 transition-colors hover:bg-zinc-50 dark:hover:bg-zinc-800">
