...
const SCHEDULES: MaintenanceSchedule[] = [
  ...
  { id: 's2', taskName: 'Fire Extinguisher Inspections', frequency: 'Annual', properties: ['Maple Ridge', '220 Main St', 'Harbor View', 'Student Housing'], nextDue: 'Jun 15, 2026', nextDueDaysOut: 54, lastCompleted: 'Jun 15, 2025', estimatedCostCents: 320000, assignedVendor: 'NH Fire Safety Co.', status: 'on-track', icon: '\uD83E\uDDEF' },
  ...
  { id: 's4', taskName: 'Pest Control Service', frequency: 'Monthly', properties: ['Maple Ridge', '220 Main St', 'Student Housing'], nextDue: 'Apr 15, 2026', nextDueDaysOut: -7, lastCompleted: 'Mar 15, 2026', estimatedCostCents: 45000, assignedVendor: 'Seacoast Pest Control', status: 'overdue', icon: '\uD83D\uDC1B' },
  ...
  { id: 's6', taskName: 'Snow Removal', frequency: 'Seasonal (Nov-Mar)', properties: ['Maple Ridge', '220 Main St', 'Harbor View', 'Student Housing'], nextDue: 'Nov 1, 2026', nextDueDaysOut: 193, lastCompleted: 'Mar 22, 2026', estimatedCostCents: 250000, assignedVendor: 'Northeast Plowing LLC', status: 'on-track', icon: '\u2744\uFE0F' },
