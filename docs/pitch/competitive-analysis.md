...
|---|---|---|---|
| **1. Labor marketplace** | Match a homeowner / Property Manager to a licensed pro | Angi, Thumbtack, TaskRabbit, Houzz Pro | **Sherpa Marketplace** — single-pro dispatch, code-aware quote validation, 5–10% take rate, Stripe Connect payment protection |
...
| Payment protection | no | no | yes (limited) | yes | no | no | **yes (Stripe Connect 7-day hold)** |
