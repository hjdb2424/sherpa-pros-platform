        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <div className="mt-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <Link
              ...
              className="inline-flex w-full items-center justify-center rounded-full bg-amber-500 px-8 py-3.5 text-base font-semibold text-[#1a1a2e] shadow-lg shadow-amber-500/25 transition-all hover:bg-amber-400 sm:w-auto"
            >
              Post a Job
            </Link>
            <Link
