  ...
  return (
    <>
      ...
      <aside className="fixed top-0 left-0 z-40 hidden h-full w-56 flex-col border-r border-zinc-100 bg-white lg:flex dark:border-zinc-800 dark:bg-zinc-950">
        ...
        {/* Bottom section: Avatar/settings block only (no public profile for tenants) */}
        <div className="border-t border-zinc-100 p-4 dark:border-zinc-800">
          {/* Avatar/name block — links to settings */}
          <SidebarUserBlock href="/tenant/settings" fallbackName="Alex Rivera" fallbackSubtitle="Tenant" />
        </div>
      </aside>
