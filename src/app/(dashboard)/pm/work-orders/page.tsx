        ...
        <div className="px-6 py-2">
          ...
          <CollapsibleSection title="Cost & Budget" defaultOpen>
            <div className="space-y-3">
              ...
              <a
                href="/pro/scan"
                className="mt-2 flex items-center justify-center gap-1.5 rounded-lg border border-dashed border-zinc-300 py-2 text-xs font-bold text-zinc-500 transition-colors hover:border-[#00a9e0] hover:text-[#00a9e0] dark:border-zinc-700 dark:hover:border-[#00a9e0]"
              >
