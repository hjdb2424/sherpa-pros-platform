  ...
  return (
    <>
      ...
      <aside className="fixed top-0 left-0 z-40 hidden h-full w-64 flex-col border-r border-zinc-100 bg-white lg:flex dark:border-zinc-800 dark:bg-zinc-950">
        ...
        {/* Bottom section: Company Profile link + Avatar/settings block */}
        <div className="border-t border-zinc-100 p-4 space-y-3 dark:border-zinc-800">
          {/* Company Profile link — public storefront */}
          <Link
            href="/pm/profile"
            data-tour="profile"
          ...
          <SidebarUserBlock href="/pm/settings" fallbackName="Lisa Park" fallbackSubtitle="Property Manager" />
        </div>
      </aside>
