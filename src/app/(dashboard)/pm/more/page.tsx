...
const moreItems = [
  {
    label: 'Vendors',
    description: 'Manage your vendor network and contacts',
    href: '/pm/vendors',
    icon: (
  ...
  {
    label: 'Make-Ready',
    description: 'Unit turnover tracking and checklists',
    href: '/pm/make-ready',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
  ...
  {
    label: 'Analytics',
    description: 'Reports, trends, and performance data',
    href: '/pm/analytics',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
  ...
  {
    label: 'Finance Hub',
    description: 'Tax documents and financial reports',
    href: '/pm/tax',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
  ...
  },
  {
    ...
    description: 'Manage your public company profile',
    href: '/pm/profile',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
...
export default function PMMorePage() {
  return (
