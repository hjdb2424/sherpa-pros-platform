...
const PROFILES: Record<string, PublicProfile> = {
  'mike-rodriguez': {
    ...
    bio: 'Licensed master plumber with 15 years experience specializing in residential and light commercial plumbing. Emergency services available 24/7.',
  ...
  'seacoast-pm': {
    ...
    headline: 'Managing 123 units since 2019',
    location: 'Portsmouth, NH',
    rating: 4.8,
    reviewCount: 28,
    avatar: null,
    ...
    bio: 'Full-service property management company specializing in multi-family, mixed-use, and student housing with a focus on maximizing NOI and tenant retention.',
    specialties: [],
    properties: [
  ...
  'phyrom-oum': {
    ...
    bio: 'Property owner focused on quality renovations and long-term property value.',
    specialties: [],
    propertiesOwned: [
