...
### 5.3 Why the new platform capability layer (Sherpa Smart Scan + Sherpa Threads) reduces the operational lift of Interpretation B

The two platform capabilities shipped 2026-04-25 alongside Sherpa Flex (commits `67ccfc8`, `8933f67`, `60781c1`, `2f1eec4`) **directly de-risk the "employees with side bandwidth" path** in two specific ways: (a) **Sherpa Smart Scan** — Optical Character Recognition (OCR) for receipts, invoices, permits, and job-site photos — lets the construction-company employee scan side-gig receipts on their phone *while they are on the side gig*, and the receipts auto-route to the employee's **personal Schedule C** (their own 1099 books) rather than getting commingled with the day-job employer's expense system. That dissolves the most common operational friction point of moonlighting (lost receipts, blurred-line tax exposure, the day-job bookkeeper accidentally seeing side-gig spend). (b) **Sherpa Threads** — in-app chat with Short Message Service (SMS) sync — keeps every client conversation in-app, so **the employee's personal phone number never leaks to the side-gig client**. That removes the worst privacy / boundary risk of moonlighting (client texts the personal number at 11 p.m., on weekends, during day-job hours, or after the relationship ends). Together these capabilities take the two highest-friction moments in the moonlighter workflow (expense capture and client communication) and move them onto the platform — making it materially easier for a construction-company tradesperson to take side jobs through Sherpa Flex without spillover into their day-job employer's systems or their personal life. This is a **Phase 1 unlock**, not a Phase 2 nice-to-have, because both capabilities are LIVE today.
