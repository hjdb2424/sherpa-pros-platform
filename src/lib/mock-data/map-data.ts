...
export const MOCK_PROS: MockProLocation[] = [
  ...
  // Dover, NH
  { id: 'pro-9', name: 'Pete Moreau', initials: 'PM', trade: 'Electrician', rating: 4.7, reviewCount: 65, lat: 43.1979, lng: -70.8737, verified: true, distance: '9.2 mi', responseTime: '< 2 hr', jobsCompleted: 41 },
  // Kittery, ME
  { id: 'pro-10', name: 'Nate Collins', initials: 'NC', trade: 'HVAC', rating: 4.8, reviewCount: 91, lat: 43.0884, lng: -70.7356, verified: true, distance: '1.6 mi', responseTime: '< 1 hr', jobsCompleted: 52 },
  // Newburyport, MA
  { id: 'pro-11', name: 'Karen Ouelette', initials: 'KO', trade: 'General Contractor', rating: 4.9, reviewCount: 117, lat: 42.8126, lng: -70.8773, verified: true, distance: '18.4 mi', responseTime: 'Same day', jobsCompleted: 73 },
  // Manchester, NH
  { id: 'pro-12', name: 'Derek Stone', initials: 'DS', trade: 'Roofer', rating: 4.6, reviewCount: 48, lat: 42.9956, lng: -71.4548, verified: true, distance: '38.1 mi', responseTime: '< 4 hr', jobsCompleted: 34 },
];
...
export const MOCK_JOBS: MockJobLocation[] = [
  ...
  // Dover, NH
  { id: 'job-7', title: 'Whole-House Rewire', category: 'Electrical', budget: 8500, urgency: 'standard', lat: 43.1910, lng: -70.8685, distance: '9.0 mi', postedAgo: '6h ago' },
  // Kittery, ME
  { id: 'job-8', title: 'Roof Leak Repair', category: 'Roofing', budget: 1200, urgency: 'emergency', lat: 43.0900, lng: -70.7400, distance: '1.8 mi', postedAgo: '45m ago' },
  // Newburyport, MA
  { id: 'job-9', title: 'Exterior Painting — Colonial', category: 'Painting', budget: 6500, urgency: 'flexible', lat: 42.8100, lng: -70.8800, distance: '18.6 mi', postedAgo: '2d ago' },
  // Manchester, NH
  { id: 'job-10', title: 'Mini-Split Installation', category: 'HVAC', budget: 4200, urgency: 'standard', lat: 42.9900, lng: -71.4600, distance: '38.3 mi', postedAgo: '1d ago' },
];
