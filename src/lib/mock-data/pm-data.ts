...
export const mockComplianceItems: MockComplianceItem[] = [
  // 2 overdue
  {
    ...
    description: "Annual boiler inspection — Certificate of Compliance required by State Fire Marshal.",
    due_date: "2026-03-01",
    completed_date: null,
    status: "overdue",
  ...
  // 3 due soon
  {
    ...
    property_id: PROPERTY_IDS.harbor,
    item_type: "elevator",
    description: "Semi-annual elevator inspection — required by state regulations.",
    due_date: "2026-05-01",
    completed_date: null,
    status: "due_soon",
    certificate_url: null,
  ...
  },
  {
    ...
    property_id: PROPERTY_IDS.main,
    item_type: "backflow",
    description: "Annual backflow preventer test — required by local water utility.",
    due_date: "2026-05-15",
    completed_date: null,
    status: "due_soon",
    certificate_url: null,
