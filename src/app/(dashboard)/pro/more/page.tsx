...
const moreItems = [
  {
    label: 'Finance Hub',
    description: 'Tax documents, 1099s, and financial reports',
    href: '/pro/tax',
    icon: (
  ...
  {
    label: 'Smart Scan',
    description: 'Scan receipts, licenses, and documents',
    href: '/pro/scan',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
  ...
  {
    label: 'Referrals',
    description: 'Invite pros and earn bonus points',
    href: '/referral',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
  ...
  {
    label: 'Sherpa Flex',
    description: 'Insurance and benefits coverage',
    href: '/pro/flex',
    icon: (
      <svg className="h-6 w-6" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden="true">
...
export default function ProMorePage() {
  return (
