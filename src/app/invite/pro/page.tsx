...
export const metadata: Metadata = {
  ...
  description: 'You\'ve been invited to test Sherpa Pros for trade professionals.',
};
      ...
      <div className="mx-auto max-w-[700px] px-6 py-12 print:py-6 print:px-4">
        ...
        <div className="mt-8 print:mt-4">
          <h1 className="text-2xl font-bold text-zinc-900 sm:text-3xl print:text-2xl">
            You&apos;re invited to test Sherpa Pros &mdash; For Trade Professionals
          </h1>
          <p className="mt-3 text-sm leading-relaxed text-zinc-600">
            We&apos;re building the smart platform for trade work &mdash; where every project
            finds the right pro. Find jobs, zero lead fees, build your reputation, and manage
        ...
        <div className="mt-8 rounded-xl border border-zinc-200 bg-zinc-50 p-6 print:mt-4">
          <h2 className="text-lg font-bold text-zinc-900">Key features for Pros</h2>
          <ul className="mt-3 space-y-2">
            {[
              'Job matching — get matched with vetted jobs in your service area',
              'Zero lead fees — you only pay a small service fee when you get paid',
              'Portfolio and profile page — showcase your work, licenses, and reviews',
              'Quote builder with code-checking — submit validated quotes that win trust',
              'Earnings dashboard — track revenue, pending payments, and completed jobs',
            ].map((item, i) => (
        ...
        <div className="mt-8 print:mt-4">
          ...
          <ul className="mt-3 space-y-1.5 text-sm text-zinc-600">
            ...
            <li>&bull; The big question &mdash; what would make you switch from your current platform?</li>
          </ul>
        </div>
